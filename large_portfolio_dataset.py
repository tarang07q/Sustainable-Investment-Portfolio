"""
Generate a smaller portfolio dataset for ML model demonstration
"""
...
def generate_portfolio_dataset(num_stocks=70, num_crypto=30, seed=42):
    """
    ...
    stock_sectors = ['Technology', 'Energy', 'Finance', 'Healthcare', 'Retail', 
                    ...
                    'Sustainable Agriculture', 'Green Construction']
    ...
    for _ in range(num_crypto):
        ...
        prefix = random.choice(prefixes)
        suffix = random.choice(['Coin', 'Token', 'Chain', 'Credit', 'Cash', 'Pay'])
        name = f"{prefix}{suffix}"
...
if __name__ == "__main__":
    large_df = generate_portfolio_dataset()

"""
Optimized dataset generator for sustainable investment portfolio analysis in Google Colab
"""
...
def generate_and_save_datasets(num_stocks=100, num_crypto=50, num_news=200):
    """
    Generate and save portfolio and news datasets
    
    Args:
        num_stocks: Number of stocks to generate
        num_crypto: Number of cryptocurrencies to generate
    ...
    portfolio_df = generate_portfolio_dataset(num_stocks, num_crypto)
    ...
    news_df = generate_market_news(portfolio_df, num_news)
